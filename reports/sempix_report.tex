...
% summary of findings
 %wouldn't "that connects' be more fitting here? not sure about "to connect" initially wanted to write 'multimodal representation learning', but maybe it is weird? Like "Multimodal representation learning of langugage and vision"
...
% \cite{hudson2019gqa} suggest that different input representations have an impact on the results. They indicate that the more high-level and semantic representations lead to better results. This might be the reason why MCAN with BERT features performs better than with BERT encoder.
