...
class DataSet(BaseDataSet):
    def __init__(self, __C):
        ...
        # Tokenize
        self.token_to_ix, self.pretrained_emb = self.tokenize(stat_ques_list, __C.USE_GLOVE, self.tokenizer)
    ...
    def tokenize(self, stat_ques_list, use_glove, tokenizer):
    ...
    def load_ques_ans(self, idx):
        ...
        if self.__C.RUN_MODE in ['train']:
            ...
            # Process question
            ques_ix_iter = self.proc_ques(ques, self.token_to_ix, max_token, self.tokenizer)
